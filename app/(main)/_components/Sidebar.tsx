    ...
    <div className="h-full flex flex-col overflow-y-auto bg-secondary md:bg-background w-[250px]">
      ...
      <div className="flex p-4 justify-between items-center">
        <h1 className="font-bold w-auto h-8 flex items-center justify-center gap-3">
          <div className="!h-12 p-1 !w-12 !aspect-square rounded-sm text-lg lg:text-xl flex items-center justify-center !text-background">
            <img src="/ismaik.png" alt="ismaik" width={90} height={90} />
          </div>
